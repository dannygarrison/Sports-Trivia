...
/*
  ...
  All data verified from Pro-Football-Reference.com (Feb 2026).
  2023 has 31 picks (Miami forfeited their first-round selection).
*/
...
const DRAFT_CLASSES = {
  2025: {
    ...
    picks: [
      ...
      { pick: 12, name: "Tyler Booker", pos: "OG", team: "Dallas Cowboys", college: "Alabama" },
      ...
      { pick: 18, name: "Grey Zabel", pos: "OG", team: "Seattle Seahawks", college: "North Dakota State" },
      ...
      { pick: 24, name: "Donovan Jackson", pos: "OG", team: "Minnesota Vikings", college: "Ohio State" },
  ...
  2024: {
    ...
    picks: [
      ...
      { pick: 6, name: "Malik Nabers", pos: "WR", team: "New York Giants", college: "LSU" },
      { pick: 7, name: "JC Latham", pos: "OT", team: "Tennessee Titans", college: "Alabama" },
      { pick: 8, name: "Michael Penix Jr.", pos: "QB", team: "Atlanta Falcons", college: "Washington" },
      { pick: 9, name: "Rome Odunze", pos: "WR", team: "Chicago Bears", college: "Washington" },
      { pick: 10, name: "J.J. McCarthy", pos: "QB", team: "Minnesota Vikings", college: "Michigan" },
      { pick: 11, name: "Olu Fashanu", pos: "OT", team: "New York Jets", college: "Penn State" },
      { pick: 12, name: "Bo Nix", pos: "QB", team: "Denver Broncos", college: "Oregon" },
      { pick: 13, name: "Brock Bowers", pos: "TE", team: "Las Vegas Raiders", college: "Georgia" },
      { pick: 14, name: "Taliese Fuaga", pos: "OT", team: "New Orleans Saints", college: "Oregon State" },
      { pick: 15, name: "Laiatu Latu", pos: "DE", team: "Indianapolis Colts", college: "UCLA" },
      { pick: 16, name: "Byron Murphy II", pos: "DT", team: "Seattle Seahawks", college: "Texas" },
      { pick: 17, name: "Dallas Turner", pos: "LB", team: "Minnesota Vikings", college: "Alabama" },
      { pick: 18, name: "Amarius Mims", pos: "OT", team: "Cincinnati Bengals", college: "Georgia" },
      { pick: 19, name: "Jared Verse", pos: "DE", team: "Los Angeles Rams", college: "Florida State" },
      { pick: 20, name: "Troy Fautanu", pos: "OT", team: "Pittsburgh Steelers", college: "Washington" },
      { pick: 21, name: "Chop Robinson", pos: "DE", team: "Miami Dolphins", college: "Penn State" },
      { pick: 22, name: "Quinyon Mitchell", pos: "CB", team: "Philadelphia Eagles", college: "Toledo" },
      { pick: 23, name: "Brian Thomas Jr.", pos: "WR", team: "Jacksonville Jaguars", college: "LSU" },
      { pick: 24, name: "Terrion Arnold", pos: "CB", team: "Detroit Lions", college: "Alabama" },
      { pick: 25, name: "Jordan Morgan", pos: "OT", team: "Green Bay Packers", college: "Arizona" },
      { pick: 26, name: "Graham Barton", pos: "OL", team: "Tampa Bay Buccaneers", college: "Duke" },
      { pick: 27, name: "Darius Robinson", pos: "DL", team: "Arizona Cardinals", college: "Missouri" },
      { pick: 28, name: "Xavier Worthy", pos: "WR", team: "Kansas City Chiefs", college: "Texas" },
      { pick: 29, name: "Tyler Guyton", pos: "OT", team: "Dallas Cowboys", college: "Oklahoma" },
      { pick: 30, name: "Nate Wiggins", pos: "CB", team: "Baltimore Ravens", college: "Clemson" },
      { pick: 31, name: "Ricky Pearsall", pos: "WR", team: "San Francisco 49ers", college: "Florida" },
      { pick: 32, name: "Xavier Legette", pos: "WR", team: "Carolina Panthers", college: "South Carolina" },
    ],
  },
  2023: {
    ...
    picks: [
      ...
      { pick: 9, name: "Jalen Carter", pos: "DT", team: "Philadelphia Eagles", college: "Georgia" },
      { pick: 10, name: "Darnell Wright", pos: "OT", team: "Chicago Bears", college: "Tennessee" },
      { pick: 11, name: "Peter Skoronski", pos: "OL", team: "Tennessee Titans", college: "Northwestern" },
      { pick: 12, name: "Jahmyr Gibbs", pos: "RB", team: "Detroit Lions", college: "Alabama" },
      { pick: 13, name: "Lukas Van Ness", pos: "EDGE", team: "Green Bay Packers", college: "Iowa" },
      { pick: 14, name: "Broderick Jones", pos: "OT", team: "Pittsburgh Steelers", college: "Georgia" },
      { pick: 15, name: "Will McDonald IV", pos: "DE", team: "New York Jets", college: "Iowa State" },
      { pick: 16, name: "Emmanuel Forbes", pos: "CB", team: "Washington Commanders", college: "Mississippi State" },
      { pick: 17, name: "Christian Gonzalez", pos: "CB", team: "New England Patriots", college: "Oregon" },
      { pick: 18, name: "Jack Campbell", pos: "LB", team: "Detroit Lions", college: "Iowa" },
      { pick: 19, name: "Calijah Kancey", pos: "DT", team: "Tampa Bay Buccaneers", college: "Pittsburgh" },
      { pick: 20, name: "Jaxon Smith-Njigba", pos: "WR", team: "Seattle Seahawks", college: "Ohio State" },
      { pick: 21, name: "Quentin Johnston", pos: "WR", team: "Los Angeles Chargers", college: "TCU" },
      { pick: 22, name: "Zay Flowers", pos: "WR", team: "Baltimore Ravens", college: "Boston College" },
      { pick: 23, name: "Jordan Addison", pos: "WR", team: "Minnesota Vikings", college: "USC" },
      { pick: 24, name: "Deonte Banks", pos: "CB", team: "New York Giants", college: "Maryland" },
      { pick: 25, name: "Dalton Kincaid", pos: "TE", team: "Buffalo Bills", college: "Utah" },
      { pick: 26, name: "Mazi Smith", pos: "DT", team: "Dallas Cowboys", college: "Michigan" },
      { pick: 27, name: "Anton Harrison", pos: "OT", team: "Jacksonville Jaguars", college: "Oklahoma" },
      { pick: 28, name: "Myles Murphy", pos: "DE", team: "Cincinnati Bengals", college: "Clemson" },
      { pick: 29, name: "Bryan Bresee", pos: "DT", team: "New Orleans Saints", college: "Clemson" },
      { pick: 30, name: "Nolan Smith", pos: "EDGE", team: "Philadelphia Eagles", college: "Georgia" },
      { pick: 31, name: "Felix Anudike-Uzomah", pos: "EDGE", team: "Kansas City Chiefs", college: "Kansas State" },
    ],
  },
  2022: {
    ...
    picks: [
      ...
      { pick: 16, name: "Jahan Dotson", pos: "WR", team: "Washington Commanders", college: "Penn State" },
      { pick: 17, name: "Zion Johnson", pos: "OG", team: "Los Angeles Chargers", college: "Boston College" },
      { pick: 18, name: "Treylon Burks", pos: "WR", team: "Tennessee Titans", college: "Arkansas" },
      { pick: 19, name: "Trevor Penning", pos: "OT", team: "New Orleans Saints", college: "Northern Iowa" },
      { pick: 20, name: "Kenny Pickett", pos: "QB", team: "Pittsburgh Steelers", college: "Pittsburgh" },
      { pick: 21, name: "Trent McDuffie", pos: "CB", team: "Kansas City Chiefs", college: "Washington" },
      { pick: 22, name: "Quay Walker", pos: "LB", team: "Green Bay Packers", college: "Georgia" },
      { pick: 23, name: "Kaiir Elam", pos: "CB", team: "Buffalo Bills", college: "Florida" },
      { pick: 24, name: "Tyler Smith", pos: "OT", team: "Dallas Cowboys", college: "Tulsa" },
      { pick: 25, name: "Tyler Linderbaum", pos: "C", team: "Baltimore Ravens", college: "Iowa" },
      { pick: 26, name: "Jermaine Johnson II", pos: "DE", team: "New York Jets", college: "Florida State" },
      { pick: 27, name: "Devin Lloyd", pos: "LB", team: "Jacksonville Jaguars", college: "Utah" },
      { pick: 28, name: "Devonte Wyatt", pos: "DT", team: "Green Bay Packers", college: "Georgia" },
      { pick: 29, name: "Cole Strange", pos: "OG", team: "New England Patriots", college: "Chattanooga" },
      { pick: 30, name: "George Karlaftis", pos: "DE", team: "Kansas City Chiefs", college: "Purdue" },
      { pick: 31, name: "Daxton Hill", pos: "S", team: "Cincinnati Bengals", college: "Michigan" },
      { pick: 32, name: "Lewis Cine", pos: "S", team: "Minnesota Vikings", college: "Georgia" },
    ],
  },
  2021: {
    ...
    picks: [
      ...
      { pick: 11, name: "Justin Fields", pos: "QB", team: "Chicago Bears", college: "Ohio State" },
      { pick: 12, name: "Micah Parsons", pos: "LB", team: "Dallas Cowboys", college: "Penn State" },
      { pick: 13, name: "Rashawn Slater", pos: "OT", team: "Los Angeles Chargers", college: "Northwestern" },
      ...
      { pick: 20, name: "Kadarius Toney", pos: "WR", team: "New York Giants", college: "Florida" },
      { pick: 21, name: "Kwity Paye", pos: "DE", team: "Indianapolis Colts", college: "Michigan" },
      { pick: 22, name: "Caleb Farley", pos: "CB", team: "Tennessee Titans", college: "Virginia Tech" },
      { pick: 23, name: "Christian Darrisaw", pos: "OT", team: "Minnesota Vikings", college: "Virginia Tech" },
      { pick: 24, name: "Najee Harris", pos: "RB", team: "Pittsburgh Steelers", college: "Alabama" },
      { pick: 25, name: "Travis Etienne", pos: "RB", team: "Jacksonville Jaguars", college: "Clemson" },
      { pick: 26, name: "Greg Newsome II", pos: "CB", team: "Cleveland Browns", college: "Northwestern" },
      { pick: 27, name: "Rashod Bateman", pos: "WR", team: "Baltimore Ravens", college: "Minnesota" },
      { pick: 28, name: "Payton Turner", pos: "DE", team: "New Orleans Saints", college: "Houston" },
      { pick: 29, name: "Eric Stokes", pos: "CB", team: "Green Bay Packers", college: "Georgia" },
      { pick: 30, name: "Gregory Rousseau", pos: "DE", team: "Buffalo Bills", college: "Miami (FL)" },
      { pick: 31, name: "Odafe Oweh", pos: "DE", team: "Baltimore Ravens", college: "Penn State" },
      { pick: 32, name: "Joe Tryon-Shoyinka", pos: "OLB", team: "Tampa Bay Buccaneers", college: "Washington" },
    ],
  },
  2020: {
    ...
    picks: [
      ...
      { pick: 13, name: "Tristan Wirfs", pos: "OT", team: "Tampa Bay Buccaneers", college: "Iowa" },
      { pick: 14, name: "Javon Kinlaw", pos: "DT", team: "San Francisco 49ers", college: "South Carolina" },
      { pick: 15, name: "Jerry Jeudy", pos: "WR", team: "Denver Broncos", college: "Alabama" },
      { pick: 16, name: "A.J. Terrell", pos: "CB", team: "Atlanta Falcons", college: "Clemson" },
      { pick: 17, name: "CeeDee Lamb", pos: "WR", team: "Dallas Cowboys", college: "Oklahoma" },
      { pick: 18, name: "Austin Jackson", pos: "OT", team: "Miami Dolphins", college: "USC" },
      { pick: 19, name: "Damon Arnette", pos: "CB", team: "Las Vegas Raiders", college: "Ohio State" },
      { pick: 20, name: "K'Lavon Chaisson", pos: "DE", team: "Jacksonville Jaguars", college: "LSU" },
      { pick: 21, name: "Jalen Reagor", pos: "WR", team: "Philadelphia Eagles", college: "TCU" },
      { pick: 22, name: "Justin Jefferson", pos: "WR", team: "Minnesota Vikings", college: "LSU" },
      { pick: 23, name: "Kenneth Murray", pos: "LB", team: "Los Angeles Chargers", college: "Oklahoma" },
      { pick: 24, name: "Cesar Ruiz", pos: "C", team: "New Orleans Saints", college: "Michigan" },
      { pick: 25, name: "Brandon Aiyuk", pos: "WR", team: "San Francisco 49ers", college: "Arizona State" },
      { pick: 26, name: "Jordan Love", pos: "QB", team: "Green Bay Packers", college: "Utah State" },
      { pick: 27, name: "Jordyn Brooks", pos: "LB", team: "Seattle Seahawks", college: "Texas Tech" },
      { pick: 28, name: "Patrick Queen", pos: "LB", team: "Baltimore Ravens", college: "LSU" },
      { pick: 29, name: "Isaiah Wilson", pos: "OT", team: "Tennessee Titans", college: "Georgia" },
      { pick: 30, name: "Noah Igbinoghene", pos: "CB", team: "Miami Dolphins", college: "Auburn" },
      { pick: 31, name: "Jeff Gladney", pos: "CB", team: "Minnesota Vikings", college: "TCU" },
