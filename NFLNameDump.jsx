...
const NFL_NORMALIZED = new Map();
NFL_PLAYER_SET.forEach(name => {
  NFL_NORMALIZED.set(name.toLowerCase().trim(), name);
});
...
export default function NFLNameDump() {
  ...
  const inDatabase = NFL_NORMALIZED.size;
  ...
  return (
    <div style={{
      ...
      <div style={{ maxWidth: 680, margin: "0 auto", animation: "fadeUp 0.4s ease both" }}>

        {/* Header */}
        <div style={{ marginBottom: 28 }}>
          <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: 4, textTransform: "uppercase", color: "#e74c3c", marginBottom: 8 }}>
            NFL · Free Recall
          </div>
          <h1 style={{
        ...
        <div style={{ display: "flex", gap: 24, marginBottom: 24, flexWrap: "wrap", alignItems: "center" }}>
          <div>
            <div style={{ fontSize: 9, letterSpacing: 3, textTransform: "uppercase", color: "#ffffff25", marginBottom: 2 }}>Named</div>
            <div style={{ fontSize: 52, fontWeight: 900, color: "#2ecc71", lineHeight: 1, fontVariantNumeric: "tabular-nums" }}>
              {total}
            </div>
          </div>
        ...
        <div style={{ minHeight: 44, marginBottom: 16 }}>
          ...
          {flash === "dupe" && dupeMessage && (
            <div style={{ fontSize: 12, color: "#c8a05088", fontFamily: "Georgia, serif" }}>
              You already got {dupeMessage}!
            </div>
          )}
          {flash === "hit" && found[0] && (
            <div style={{ fontSize: 12, color: "#4db87a88", fontFamily: "Georgia, serif" }}>
              ✓ {found[0].name} — {total} total!
            </div>
          )}
        </div>
        ...
        {found.length > 0 && (
          <div style={{
            ...
            <div style={{
              ...
              textTransform: "uppercase", color: "#ffffff25",
            }}>
              Players Named — {total} total
            </div>
            <div style={{ maxHeight: 450, overflowY: "auto" }}>
              {found.map((entry, i) => (
                <div key={entry.id} style={{
                  ...
                  padding: "9px 16px",
                  borderBottom: i < found.length - 1 ? "1px solid #ffffff05" : "none",
                  background: i === 0 ? "#e74c3c08" : i % 2 === 0 ? "#09090f" : "#07070d",
                  animation: i === 0 ? "popIn 0.25s ease both" : "none",
                }}>
                  <span style={{
