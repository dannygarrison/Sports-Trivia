...
const PLAYERS = [
  ...
  { name: "Corey Linsley", colleges: ["Ohio State"], position: "OL", teams: ["Green Bay Packers", "Los Angeles Chargers"] },
  ...
  { name: "Mike McGlinchey", colleges: ["Notre Dame"], position: "OL", teams: ["San Francisco 49ers", "Denver Broncos"] },
  { name: "Alejandro Villanueva", colleges: ["Army"], position: "OL", teams: ["Pittsburgh Steelers", "Baltimore Ravens"] },
  { name: "Mitchell Schwartz", colleges: ["California"], position: "OL", teams: ["Cleveland Browns", "Kansas City Chiefs"] },
  { name: "Chase Young", colleges: ["Ohio State"], position: "DE", teams: ["Washington Commanders", "San Francisco 49ers"] },
  ...
  { name: "Wyatt Teller", colleges: ["Virginia Tech"], position: "OG", teams: ["Buffalo Bills","Cleveland Browns"] },
  { name: "Erik McCoy", colleges: ["Texas A&M"], position: "C", teams: ["New Orleans Saints"] },
  { name: "Kaleb McGary", colleges: ["Washington"], position: "OT", teams: ["Atlanta Falcons","Denver Broncos"] },
  { name: "Tytus Howard", colleges: ["Alabama State"], position: "OT", teams: ["Houston Texans"] },
  { name: "Andre Dillard", colleges: ["Washington State"], position: "OT", teams: ["Philadelphia Eagles"] },
  { name: "Dalton Risner", colleges: ["Kansas State"], position: "OG", teams: ["Denver Broncos","Minnesota Vikings"] },
