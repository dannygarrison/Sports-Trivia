...
const PLAYERS = [
  ...
  { name: "Mac Jones", colleges: ["Alabama"], position: "QB", teams: ["New England Patriots", "Jacksonville Jaguars", "San Francisco 49ers"] },
  ...
  { name: "Eric Kendricks", colleges: ["UCLA"], position: "LB", teams: ["Minnesota Vikings", "Los Angeles Chargers", "Dallas Cowboys", "San Francisco 49ers"] },
  ...
  { name: "Adonai Mitchell", colleges: ["Texas"], position: "WR", teams: ["Indianapolis Colts", "New York Jets"] },
  ...
  { name: "Clelin Ferrell", colleges: ["Clemson"], position: "DE", teams: ["Las Vegas Raiders", "Washington Commanders", "San Francisco 49ers"] },
