...
const JERSEY_DATA = [
  ...
  { number: 84, team: "Oakland Raiders", sport: "NFL", players: ["Randy Moss"], hints: ["Brief stint after Minnesota"] },
  ...
  { number: 20, team: "Oakland Raiders", sport: "NFL", players: ["Charles Woodson"], hints: ["Heisman winner, DPOY with the Packers"] },
  ...
  { number: 29, team: "St. Louis Rams", sport: "NFL", players: ["Eric Dickerson"], hints: ["Single-season rushing record, 2,105 yards in 1984"] },
  ...
  { number: 10, team: "Denver Broncos", sport: "NFL", players: ["Rod Smith"], hints: ["Undrafted, all-time Broncos receiving leader"] },
  ...
  { number: 25, team: "San Francisco 49ers", sport: "NFL", players: ["Richard Sherman"], hints: ["Best corner you've seen, tip in the NFC Championship"] },
  ...
  { number: 11, team: "Utah Jazz", sport: "NBA", players: ["John Stockton"], hints: ["All-time assists and steals leader"] },
  ...
  { number: 2, team: "Houston Rockets", sport: "NBA", players: ["Moses Malone"], hints: ["Fo, fo, fo - predicted a sweep in 1983"] },
