...
const JERSEY_DATA = [
  ...
  { number: 4, team: "Green Bay Packers", sport: "NFL", players: ["Brett Favre"], hints: ["Ironman QB, 297 consecutive starts"] },
  { number: 4, team: "Minnesota Vikings", sport: "NFL", players: ["Brett Favre"], hints: ["Played his final seasons here"] },
  ...
  { number: 42, team: "Arizona Cardinals", sport: "NFL", players: ["Pat Tillman"], hints: ["Left NFL to serve in the Army"] },
  { number: 71, team: "Washington Redskins", sport: "NFL", players: ["Charles Mann"], hints: ["3x Super Bowl champion DE"] },
...
export default function WhoWoreIt() {
  ...
  // Auto-advance if all players found
  useEffect(() => {
  ...
  }, [allFound, showAnswer, foundPlayers.size, item]);
        ...
        <div style={{ display: "flex", alignItems: "flex-end", justifyContent: "space-between", flexWrap: "wrap", gap: 12 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: "#c8a050", margin: "7px 0 0", fontFamily: "Georgia, serif" }}>
              Name the player(s) who wore the jersey number. {ROUND_SIZE} questions per round.
            </p>
          </div>
